...
#include "../lib/HorizontalStepperControl/src/HorizontalStepperControl.h"
#include "../lib/HighPowerStepperDriver/src/HighPowerStepperDriver.h"

const uint8_t MaxRotation = 3;
